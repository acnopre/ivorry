                        ...
                        Section::make('Address')
                            ...
                            ->schema([
                                Forms\Components\Select::make('region_id')
                                    ...
                                    ->getOptionLabelUsing(fn($value) => \App\Models\Region::find($value)?->name)
                                    ->searchable()
                                    ->reactive()
                                ...
                                Forms\Components\Select::make('province_id')
                                    ...
                                    ->getOptionLabelUsing(fn($value) => \App\Models\Province::find($value)?->name)
                                    ->searchable()
                                    ->reactive()
                                ...
                                Forms\Components\Select::make('municipality_id')
                                    ...
                                    ->getOptionLabelUsing(fn($value) => \App\Models\Municipality::find($value)?->name)
                                    ->searchable()
                                    ->reactive()
                                ...
                                Forms\Components\Select::make('barangay_id')
                                    ...
                                    ->options(fn(callable $get) => $get('municipality_id')
                                        ...
                                        : \App\Models\Barangay::pluck('name', 'id'))
                                    ->getOptionLabelUsing(fn($value) => \App\Models\Barangay::find($value)?->name)
                                    ->searchable()
                                    ->required(),
