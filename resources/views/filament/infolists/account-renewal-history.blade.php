<div class="space-y-4">
    ...
    <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 overflow-hidden">
        {{-- COLLAPSIBLE HEADER --}}
        <button 
            onclick="this.nextElementSibling.classList.toggle('hidden'); this.querySelector('.chevron-down').classList.toggle('hidden'); this.querySelector('.chevron-up').classList.toggle('hidden');"
            type="button"
            class="w-full px-6 py-4 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
        >
            <div class="flex items-center justify-between">
                ...
                <div>
                    <x-heroicon-m-chevron-down class="w-5 h-5 text-gray-400 chevron-down" />
                    <x-heroicon-m-chevron-up class="w-5 h-5 text-gray-400 chevron-up hidden" />
                </div>
            </div>
        </button>
